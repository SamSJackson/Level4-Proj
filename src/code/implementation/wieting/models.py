...
import src.code.implementation.wieting.pairing as pairing
import src.code.implementation.wieting.utils as utils
from src.code.implementation.wieting.evaluate_sts import evaluate_sts
...
def load_model(model_name: str, sp_model: str, data=None, lstm: bool = False, gpu: bool = False):
    ...
    model_args.gpu = 1 if gpu else 0
