...
from src.code.implementation.wieting.models import load_model
from src.code.implementation.wieting.measure import make_sim_object, evaluate
...
if __name__ == "__main__":
    calculate_similarity_and_get_path(
        input_dir="../../../data/processed/cleaned_paraphrased/clean_497_17_03_2024.csv",
