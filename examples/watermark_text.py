...
from hard_watermark_processor import HardWatermarkLogitsProcessor
...
input_text = "I am often wondering about the significance of death and "

watermark_processor = HardWatermarkLogitsProcessor(vocab=list(tokenizer.get_vocab().values()),
                                               gamma=0.50,
                                               delta=2.0,
